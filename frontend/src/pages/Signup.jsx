  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#1F1C2C] via-[#2D2B4E] to-[#928DAB] flex items-center justify-center px-4">
      <div className="bg-[#1F1C2C] border border-[#2D2B4E] p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-3xl font-bold text-center text-[#928DAB] mb-8">Create Your Account</h2>

        <form onSubmit={handleSubmit} autoComplete="off" className="space-y-5">
          <div>
            <label htmlFor="username" className="block text-[#d1cfe9] font-medium">Username</label>
            <input
              type="text"
              id="username"
              name="username"
          ...
          <div>
            <label htmlFor="phone" className="block text-[#d1cfe9] font-medium">Phone</label>
            <input
              type="number"
              id="phone"
              name="phone"
